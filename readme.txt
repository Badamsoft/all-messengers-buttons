...
Add WhatsApp, Telegram, MAX, Viber, Signal and other messenger buttons in one stylish floating widget.

== Description ==

All Messengers Buttons allows you to add a floating widget with messenger buttons to your WordPress site. Your visitors can easily contact you through their preferred messenger.
...
1. Upload the plugin files to the `/wp-content/plugins/all-messengers-buttons` directory, or install the plugin through the WordPress plugins screen.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Go to Settings → All Messengers Buttons to configure the plugin.
...
Go to Settings → All Messengers Buttons, navigate to the "Messengers" tab, enable the messenger you want to add, and enter your contact information (phone number, username, or link).
